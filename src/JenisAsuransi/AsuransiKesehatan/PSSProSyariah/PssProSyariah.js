...
export const PssProSyariah = () => {
    ...
    const downloadFile = () => {
      ...
      const downloadFileRingkasan = () => {
        const fileUrl = 'https://www.prudentialsyariah.co.id/export/sites/syariahcorp-id/id/.galleries/pdf/product/Product-Summary-PRUSolusi-Sehat-Plus-Pro-Syariah-230914.pdf';
        window.open(fileUrl);
      };
    ...
    <div>
        <Headers />
            ...
            <div style={{display: 'flex', flexDirection: 'row'}}>
                <div className='gapCont1' style={{flex: 0.05}} />
                <div style={{flex: 1}}>
                    <h2 style={{fontSize: 52, color: 'red'}}>PRUSolusi Sehat Plus Pro Syariah</h2>
                </div>
                <div className='gapCont1' style={{flex: 0.05}} />
            </div>
            ...
            <div style={{display: 'flex', flexDirection: 'row'}}>
                ...
                <div style={{ flex: 0.425, marginTop: 50, alignItems: 'center', marginBottom: 80}}>
                    ...
                    <p style={{paddingTop: 5, color: 'gray', textAlign: 'center', fontSize: 12}}><i>source : www.prudentialsyariah.co.id/id/health/medical/prusolusi-sehat-plus-pro-syariah/</i></p>
                </div> 
                <div className='gapCont1' style={{flex: 0.05}} />
                <div style={{flex: 0.425, marginTop: 50, alignItems: 'center', marginBottom: 80}}>
                    <p style={{fontSize: 18}}>PRUSolusi Sehat Plus Pro Syariah, sebuah produk Asuransi Kesehatan yang memberikan perlindungan tidak hanya di Indonesia, tapi juga dengan jangkauan internasional sesuai standar pelayanan Prudential Syariah yang sudah melindungi jutaan pesertanya.</p>
            ...
            <div style={{display: 'flex', flexDirection: 'row', marginTop: 40}}>
                ...
                <div style={{flex: 1, backgroundColor: 'red', borderRadius: 18}}>
                    ...
                    <div style={{display: 'flex', flexDirection: 'row'}}>
                        ...
                        <div style={{flex: 1, borderBottomColor: 'white', borderBottomStyle: 'solid', borderBottomWidth: 3, paddingTop: 24, paddingBottom: 24}}>
                            <p style={{color: 'white', fontSize: 18, fontWeight: 700}}>Rp220.000/Bulan</p>
                        </div> 
                        <div style={{flex: 0.05, borderBottomColor: 'white', borderBottomStyle: 'solid', borderBottomWidth: 3}} />
                    </div>
                    ...
                    <div style={{display: 'flex', flexDirection: 'row'}}>
                        ...
                        <div style={{flex: 1, borderBottomColor: 'white', borderBottomStyle: 'solid', borderBottomWidth: 3, paddingTop: 24, paddingBottom: 24}}>
                            <p style={{color: 'white', fontSize: 18, fontWeight: 700}}>1 (satu) tahun dan dapat diperpanjang hingga Peserta yang Diasuransikan berusia 99 tahun</p>
                        </div> 
                        <div style={{flex: 0.05, borderBottomColor: 'white', borderBottomStyle: 'solid', borderBottomWidth: 3}} />
                    </div>
                    ...
                    <div style={{display: 'flex', flexDirection: 'row'}}>
                        ...
                        <div style={{flex: 1, borderBottomColor: 'white', borderBottomStyle: 'solid', borderBottomWidth: 3, paddingTop: 24, paddingBottom: 24}}>
                            ...
                            <ul>
                                ...
                                <li style={{color: 'white', fontSize: 18, fontWeight: 700, paddingTop: 10}}>Fotokopi kartu identitas Pemegang Polis dan Peserta Yang Diasuransikan yang masih berlaku</li>
                                <li style={{color: 'white', fontSize: 18, fontWeight: 700, paddingTop: 10}}>Membayar Kontribusi melalui metode pembayaran yang tersedia (<i>cash/queue, credit card,</i> dan <i>auto debit</i> atau metode pembayaran lainnya)</li>
                                ...
                                <li style={{color: 'white', fontSize: 18, fontWeight: 700, paddingTop: 10}}>Dokumen-dokumen lain yang Prudential Syariah perlukan sebagai syarat penerbitan Polis</li>
                                <li style={{color: 'white', fontSize: 18, fontWeight: 700, paddingTop: 10}}>Memenuhi kriteria <i>financial underwriting</i> yang berlaku di Prudential Syariah</li>
                            </ul>
                        </div> 
                        <div style={{flex: 0.05, borderBottomColor: 'white', borderBottomStyle: 'solid', borderBottomWidth: 3}} />
                    </div>
                ...
                <div style={{flex: 1, backgroundColor: 'white', borderRadius: 18, borderWidth: 4, borderColor: 'red', borderStyle: 'solid'}}>
                    ...
                    <div style={{display: 'flex', flexDirection: 'row', marginBottom: 10}}>
                        ...
                        <div style={{flex: 1, paddingTop: 24, paddingBottom: 12}}>
                            <p style={{fontSize: 16, color: 'red'}}>Asuransi Kesehatan PRUSolusi Sehat Plus Pro Syariah merupakan inovasi produk terbaru dari Prudential Syariah yang hadir dengan beberapa keunggulan, yaitu:</p>
                            <ol>
                                <li style={{fontSize: 16, color: 'red', paddingTop: 10}}>Fleksibilitas dalam menentukan Cakupan Wilayah Asuransi, pilihan kamar, dan batas harga Kamar sesuai plan yang dipilih.</li>
                                ...
                                <li style={{fontSize: 16, color: 'red', paddingTop: 10}}>Perawatan Paliatif, ditunjukan untuk meningkatkan kualitas hidup Peserta Yang Diasuransikan berdasarkan rekomendasi dari dokter yang merawat, termasuk rawat jalan dan rawat inap (hanya berlaku pada plan tertentu).</li>
                                ...
                                <li style={{fontSize: 16, color: 'red', paddingTop: 10}}>Perawatan Psikiatri dan psikologis atas rekomendasi tertulis dari Dokter yang merawat Peserta Yang Diasuransikan pada saat Rawat Inap (hanya berlaku pada plan tertentu).</li>
                                <li style={{fontSize: 16, color: 'red', paddingTop: 10}}>Manfaat Telehealth di Indonesia dan Telehealth untuk Perawatan Kanker di Malaysia dan Singapura hanya di Rumah Sakit Rekanan Prudential Syariah (hanya berlaku pada plan tertentu).</li>
