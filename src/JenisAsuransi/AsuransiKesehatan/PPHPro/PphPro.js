...
export const PphPro = () => {
    ...
    const downloadFile = () => {
        const fileUrl = 'https://www.prudential.co.id/export/sites/prudential-id/id/.galleries/pdf/product/Brochure-PRUPrime-Healthcare-Plus-Pro.pdf';
        window.open(fileUrl);
      };
    ...
    <div>
        <Headers />
            ...
            <div style={{display: 'flex', flexDirection: 'row'}}>
                <div className='gapCont1' style={{flex: 0.05}} />
                <div style={{flex: 1}}>
                    <h2 style={{fontSize: 52, color: 'red'}}>PRUPrime Healthcare Plus Pro</h2>
                </div>
                <div className='gapCont1' style={{flex: 0.05}} />
            </div>
            ...
            <div style={{display: 'flex', flexDirection: 'row'}}>
                ...
                <div className='gapCont1' style={{flex: 0.05}} />
                <div style={{flex: 0.425, marginTop: 50, alignItems: 'center', marginBottom: 80}}>
                    <p style={{fontSize: 18}}>PRUPrime Healthcare Plus Pro,  produk Asuransi Tambahan yang dapat dipilih oleh Pemegang Polis pada Produk Yang Dikaitkan dengan Investasi (PAYDI) yang memberikan perlindungan  ekstra tidak hanya di Indonesia, tapi juga hingga di seluruh dunia  sesuai standar pelayanan Prudential Indonesia yang sudah  melindungi jutaan nasabahnya</p>
            ...
            <div style={{display: 'flex', flexDirection: 'row', marginTop: 40}}>
                ...
                <div style={{flex: 1, backgroundColor: 'red', borderRadius: 18}}>
                    ...
                    <div style={{display: 'flex', flexDirection: 'row'}}>
                        ...
                        <div style={{flex: 1, borderBottomColor: 'white', borderBottomStyle: 'solid', borderBottomWidth: 3, paddingTop: 24, paddingBottom: 24}}>
                            <p style={{color: 'white', fontSize: 18, fontWeight: 700}}>Masa perlindungan yang dapat dipilih hingga usia 55, 65, 75, 85, atau 99 tahun</p>
                        </div> 
                        <div style={{flex: 0.05, borderBottomColor: 'white', borderBottomStyle: 'solid', borderBottomWidth: 3}} />
                    </div>
                    ...
                    <div style={{display: 'flex', flexDirection: 'row'}}>
                        ...
                        <div style={{flex: 1, borderBottomColor: 'white', borderBottomStyle: 'solid', borderBottomWidth: 3, paddingTop: 24, paddingBottom: 24}}>
                            <ul>
                                <li style={{color: 'white', fontSize: 18, fontWeight: 700}}>1 Tertanggung hanya boleh memiliki maksimal 1 Asuransi Kesehatan sejenis di Prudential</li>
                                <li style={{color: 'white', fontSize: 18, fontWeight: 700, paddingTop: '2vh'}}>Memenuhi kriteria financial underwriting yang berlaku di Prudential.</li>
                                <li style={{color: 'white', fontSize: 18, fontWeight: 700, paddingTop: '2vh'}}>Melakukan pemeriksaan kesehatan sesuai dengan nilai Uang Pertanggungan dan usia masuk (apabila dipersyaratkan).</li>
                                <li style={{color: 'white', fontSize: 18, fontWeight: 700, paddingTop: '2vh'}}>Maksimum manfaat harian sesuai Plan yang dipilih pada tabel manfaat</li>
                            </ul>
                        </div> 
                        <div style={{flex: 0.05, borderBottomColor: 'white', borderBottomStyle: 'solid', borderBottomWidth: 3}} />
                    </div>
                    ...
                    <div style={{display: 'flex', flexDirection: 'row'}}>
                        ...
                        <div style={{flex: 1, borderBottomColor: 'white', borderBottomStyle: 'solid', borderBottomWidth: 3, paddingTop: 24, paddingBottom: 24}}>
                            <p style={{color: 'white', fontSize: 18, fontWeight: 700}}>Produk Asuransi Jiwa yang Dikaitkan Dengan Investasi (PAYDI)</p>
                        </div> 
                        <div style={{flex: 0.05, borderBottomColor: 'white', borderBottomStyle: 'solid', borderBottomWidth: 3}} />
                    </div>
                ...
                <div style={{flex: 1, backgroundColor: 'white', borderRadius: 18, borderWidth: 4, borderColor: 'red', borderStyle: 'solid'}}>
                    ...
                    <div style={{display: 'flex', flexDirection: 'row', marginBottom: 10}}>
                        ...
                        <div style={{flex: 1, paddingTop: 24, paddingBottom: 12}}>
                            <p style={{fontSize: 16, color: 'red'}}>Asuransi Kesehatan PRUPrime Healthcare Plus Pro merupakan inovasi produk terbaru dari Prudential Indonesia yang hadir dengan beberapa keunggulan, yaitu:</p>
                            <ol>
                                ...
                                <li style={{fontSize: 16, color: 'red', paddingTop: 10}}>Dapatkan manfaat hingga Rp70 miliar untuk Plan Diamond (termasuk PriPrime Limit Booster).</li>
                                <li style={{fontSize: 16, color: 'red', paddingTop: 10}}>Manfaat Biaya Bedah Rekonstruksi akibat kecelakaan atau kanker (hanya berlaku pada plan tertentu).</li>
                                ...
                                <li style={{fontSize: 16, color: 'red', paddingTop: 10}}>Perawatan Paliatif berlaku untuk manfaat rawat inap dan rawat jalan berdasarkan rekomendasi dari dokter yang merawat (hanya berlaku pada Plan tertentu).</li>
                                ...
                                <li style={{fontSize: 16, color: 'red', paddingTop: 10}}>Perawatan Psikiatri Rawat Jalan untuk kondisi psikiatri atau psikologis yang berkembang selama rawat inap atau pembedahan yang direkomendasikan oleh dokter yang merawat (hanya berlaku pada Plan tertentu).</li>
                                <li style={{fontSize: 16, color: 'red', paddingTop: 10}}>Fasilitas Free Romm Upgrade, berupa peningkatan kamar 1 (satu) kelas lebih tinggi dari Plan di Rumah Sakit yang bekerja sama dengan PRUMedical Network (PMN). SYarat dan Ketentuan pada layanan ini mengacu pada informasi website berikut <a href='https://www.prudential.co.id/export/sites/prudential-id/id/.galleries/pdf/claim-form/hospital-network/Daftar-List-Free-Room-Upgrade_Konvensional.pdf'>bit.ly/freeroomupgradePMN</a></li>
                            </ol>
                        </div>
