    ...
    <div>
        <Headers />
            ...
            <div style={{display: 'flex', flexDirection: 'row'}}>
                <div className='gapCont1' style={{flex: 0.05}} />
                <div style={{flex: 1}}>
                    <h2 style={{fontSize: 52, color: 'red'}}>PRUCinta</h2>
                </div>
                <div className='gapCont1' style={{flex: 0.05}} />
            </div>
            ...
            <div style={{display: 'flex', flexDirection: 'row'}}>
                ...
                <div className='gapCont1' style={{flex: 0.05}} />
                <div style={{flex: 0.425, marginTop: 50, alignItems: 'center', marginBottom: 80}}>
                    <p style={{fontSize: 18}}>Asuransi Jiwa Syariah PRUCinta (PRUCinta) merupakan produk Asuransi Jiwa Syariah yang menyediakan perlindungan komprehensif selama 20 tahun Masa Kepesertaan terhadap risiko meninggal dunia dan meninggal dunia karena kecelakaan. Selain memberikan perlindungan selama 20 tahun, produk ini juga memberikan perpanjangan Masa Kepesertaan tanpa pemeriksaan kesehatan dan manfaat jatuh tempo dalam bentuk Nilai Tunai atas beban Dana Nilai Tunai di akhir Masa Kepesertaan.</p>
